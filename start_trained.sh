...
echo "  ✓ Trained on LookingFor dataset (15k+ examples)"
...
if lsof -Pi :8003 -sTCP:LISTEN -t >/dev/null ; then
    ...
    if lsof -Pi :8003 -sTCP:LISTEN -t >/dev/null ; then
        ...
        echo "Model should be at: models/lookingfor-llama3-3b-lora/"
        echo ""
...
echo "  - Model: Fine-tuned Llama-3.2-3B (lookingfor-llama3-3b-lora)"
echo ""
echo "Next step:"
