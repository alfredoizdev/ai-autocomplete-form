...
DATA_DIR="bios100k_hq"  # High-quality bios100k dataset
...
python -m mlx_lm lora \
    ...
    --val-batches 50 \
    --save-every 200 \
    --adapter-path "adapters/llama3.2-3b-bios100k-hq" \
    --num-layers 24 \
    --steps-per-report 10 \
    --steps-per-eval 100

echo "Training complete! Adapter saved to adapters/llama3.2-3b-bios100k-hq"